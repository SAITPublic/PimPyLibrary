...
static void KernelLauncher(const void* inp0_data, const void* inp1_data, int N, int is_scalar, void* out_data, int32 op)
{
    ...
    PimCopyMemory((void*)pim_input1->data, (void*)inp1_data, sizeof(uint16_t) * N, DEVICE_TO_PIM);
    {
       PimBo* pim_input0 = PimCreateBo(pim_desc, MEM_TYPE_PIM);
       PimCopyMemory((void*)pim_input0->data, (void*)inp0_data, sizeof(uint16_t) * N, DEVICE_TO_PIM);
    ...
    PimCopyMemory((void*)out_data, (void*)device_output->data, sizeof(uint16_t) * N, PIM_TO_DEVICE);

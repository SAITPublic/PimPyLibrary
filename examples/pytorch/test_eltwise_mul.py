...
class PyEltMulTest(unittest.TestCase):
    def test_add_func(self):
        ...
        with torch.no_grad():
            ...
            pim_result = pim_elt.apply(input0, input1, mul)
            true_result = torch.mul(input0 ,input1)
    ...
    def test_mul_layer(self):
        ...
        with torch.no_grad():
            ...
            pim_eltwise_layer = PimEltwise(1)  # 0 for 1 , 1 for mul
